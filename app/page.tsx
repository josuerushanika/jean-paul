  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      >
        ...
        <div className="relative z-10 container mx-auto px-4 sm:px-6 lg:px-8 text-center text-white pt-16 sm:pt-20 lg:pt-28 pb-8">
          <div className="max-w-5xl mx-auto">
            ...
            <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-7xl font-extrabold mb-6 sm:mb-8 leading-tight">
              <span
                className={`block text-white drop-shadow-2xl transition-all duration-1200 ${
                  heroVisible
              ...
              <span
                className={`block text-green-400 mt-2 sm:mt-3 text-2xl sm:text-3xl md:text-4xl lg:text-6xl font-bold drop-shadow-xl transition-all duration-1200 delay-300 ${
                  heroVisible
                    ? "opacity-100 transform translate-y-0 scale-100"
                    : "opacity-0 transform translate-y-12 scale-95"
                }`}
            ...
            {/* Description */}
            <p
              className={`text-base sm:text-lg md:text-xl lg:text-2xl mb-8 sm:mb-10 text-gray-200 leading-relaxed max-w-3xl mx-auto px-2 transition-all duration-1000 delay-600 ${
                heroVisible
            ...
            <div
              className={`flex flex-col sm:flex-row gap-3 sm:gap-4 justify-center items-center transition-all duration-1000 delay-900 ${
                heroVisible
                  ? "opacity-100 transform translate-y-0"
                  : "opacity-0 transform translate-y-8"
              }`}
            >
              ...
              >
                <button className="w-full bg-green-600 hover:bg-green-700 text-white px-4 sm:px-6 py-3 sm:py-4 rounded-lg text-sm sm:text-base lg:text-lg font-semibold transition-all duration-300 border-2 border-green-600 hover:border-green-700 hover:scale-105 hover:shadow-xl leading-tight">
                  <span className="block sm:inline">{t("prepurchase")}</span>
                </button>
              </Link>
            </div>
          </div>
        ...
        {/* Floating Elements */}
        <div
          className={`absolute top-32 left-16 w-6 h-6 bg-green-400 rounded-full transition-all duration-1000 delay-1200 ${
            heroVisible ? "opacity-70 animate-bounce" : "opacity-0"
          }`}
        ></div>
        <div
          className={`absolute bottom-40 right-20 w-8 h-8 bg-blue-400 rounded-full transition-all duration-1000 delay-1500 ${
            heroVisible ? "opacity-60 animate-ping" : "opacity-0"
          }`}
        ></div>
      </section>
        ...
        <div className="container mx-auto px-4">
          ...
          >
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              {t
                ...
                : "Comprehensive solutions for sustainable biochar production and applications"}
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
            {[
              ...
              <div
                key={service.key}
                className={`bg-white p-8 rounded-xl shadow-lg hover:shadow-2xl transition-all duration-700 hover:scale-105 hover:-rotate-1 ${
                  servicesVisible
              ...
              >
                <div
                  className={`w-16 h-16 bg-${service.color}-100 rounded-lg flex items-center justify-center mb-6 transition-all duration-500 hover:rotate-12 hover:scale-110`}
                >
                  <service.Icon
                ...
                <p className="text-gray-600">
                  {t
                    ...
                    : `Description for ${service.key} service`}
                </p>
              </div>
            ))}
          </div>
      ...
      <section ref={aboutRef} className="py-20 bg-white overflow-hidden">
        <div className="container mx-auto px-4">
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            ...
            >
              <h2
                className={`text-4xl font-bold text-gray-900 mb-6 transition-all duration-800 delay-200 ${
                  aboutVisible
                    ? "opacity-100 transform translate-y-0"
              ...
              <p
                className={`text-lg text-gray-600 mb-6 leading-relaxed transition-all duration-800 delay-400 ${
                  aboutVisible
                    ? "opacity-100 transform translate-y-0"
                    : "opacity-0 transform translate-y-4"
                }`}
              ...
              <div
                className={`grid sm:grid-cols-2 gap-6 mb-8 transition-all duration-800 delay-600 ${
                  aboutVisible
                    ? "opacity-100 transform translate-y-0"
              ...
              >
                {[
                  ...
                  <div
                    key={value.key}
                    className={`flex items-center gap-3 transition-all duration-500 hover:scale-105 hover:translate-x-2 ${
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {[
              ...
              >
                <div
                  className={`relative mb-6 transition-all duration-700 hover:scale-110 ${
                    processVisible ? "scale-100" : "scale-90"
                  }`}
                >
                  <Image
                    src={step.image}
                ...
                <h3
                  className={`text-xl font-bold text-gray-900 mb-3 transition-all duration-500 ${
                    processVisible ? "opacity-100" : "opacity-0"
                  }`}
      ...
      <section ref={ctaRef} className="py-20 bg-green-600 overflow-hidden">
        <div className="container mx-auto px-4 text-center">
          ...
          <p
            className={`text-xl text-green-100 mb-8 max-w-2xl mx-auto transition-all duration-1000 delay-300 ${
              ctaVisible
                ? "opacity-100 transform translate-y-0"
                : "opacity-0 transform translate-y-8"
            }`}
        ...
        <div
          className={`absolute top-10 left-10 w-4 h-4 bg-green-300 rounded-full transition-all duration-1000 delay-1000 ${
            ctaVisible ? "opacity-70 animate-bounce" : "opacity-0"
          }`}
        ></div>
        <div
          className={`absolute bottom-10 right-10 w-6 h-6 bg-green-300 rounded-full transition-all duration-1000 delay-1200 ${
            ctaVisible ? "opacity-60 animate-ping" : "opacity-0"
          }`}
        ></div>
      </section>
